...
script_path <- if (requireNamespace("knitr", quietly = TRUE) &&
                   !is.null(knitr::current_input())) {
  # Knitting: sys.frames()/rstudioapi don't reliably see the Rmd's own path
  # inside a knit session, so ask knitr directly for the file it's rendering.
